    ...
    <div class="col-md-6">
      <div class="card h-100 shadow-sm">
        <div class="card-body">
          ...
          <a href="/TFG/views/vacunas_gestion.php" class="btn btn-primary">Administrar Vacunas</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="card h-100 shadow-sm">
        <div class="card-body">
          ...
          <a href="/TFG/views/gestionar_calendarios.php" class="btn btn-primary">Gestionar Calendarios</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="card h-100 shadow-sm">
        <div class="card-body">
          ...
          <a href="/TFG/views/recordatorios_enviados.php" class="btn btn-primary">Ver Recordatorios</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="card h-100 shadow-sm">
        <div class="card-body">
          ...
          <a href="/TFG/views/usuarios_gestion.php" class="btn btn-primary">Administrar Usuarios</a>
        </div>
      </div>
    </div>
