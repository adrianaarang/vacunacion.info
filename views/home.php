  ...
  <div id="carouselFade" class="carousel slide carousel-fade w-100" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="/TFG/views/bootstrap/img/slider/foto1.webp" class="d-block w-100" alt="Imagen 1">
      </div>
      <div class="carousel-item">
        <img src="/TFG/views/bootstrap/img/slider/foto2.webp" class="d-block w-100" alt="Imagen 2">
      </div>
      <div class="carousel-item">
        <img src="/TFG/views/bootstrap/img/slider/foto3.webp" class="d-block w-100" alt="Imagen 3">
      </div>
    </div>

    <!-- Botón anterior con accesibilidad -->
    ...
    <!-- Botón siguiente con accesibilidad -->
    ...
    <div class="col-12 col-sm-6 col-lg-4">
      <div class="card text-center shadow rounded-4 h-100">
        <div class="card-body">
          ...
          <a href="/TFG/views/calculadora.php" class="btn btn-primary">Ir a la calculadora</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-lg-4">
      <div class="card text-center shadow rounded-4 h-100">
        <div class="card-body">
          ...
          <a href="/TFG/views/calendariosVacunacion.php" class="btn btn-success text-white">Ver calendarios</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-lg-4">
      <div class="card text-center shadow rounded-4 h-100">
        <div class="card-body">
          ...
          <a href="/TFG/views/preguntasFrecuentes.php" class="btn btn-warning text-dark">Ver preguntas</a>
        </div>
      </div>
    </div>
