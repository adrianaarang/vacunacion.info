...
<section id="sobre-nosotros" class="py-5">
  <div class="container-xl"> <!-- ✅ Más ancho que "container" por defecto -->
    <h2 class="text-center section-header mb-4">Sobre vacunacion.info</h2>
    <p class="text-center mb-5 mx-auto" style="max-width: 720px;">
      En <strong>vacunacion.info</strong>, somos una organización sin ánimo de lucro compuesta por profesionales sanitarias y desarrolladoras.
