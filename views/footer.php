<!-- footer.php -->
<footer class="footer-personalizado text-white mt-5 py-4">
  <div class="container">
    <div class="row text-center text-md-start">
      <!-- Columna 1: Derechos -->
      <div class="col-md-4 mb-3">
        <p>&copy; 2025 Vacunacion.info – Todos los derechos reservados.</p>
        <div class="social-icons mt-2">
          <a href="#" target="_blank" title="Facebook"><i class="bi bi-facebook text-white"></i></a>
          <a href="#" target="_blank" title="Twitter"><i class="bi bi-twitter text-white"></i></a>
          <a href="#" target="_blank" title="Instagram"><i class="bi bi-instagram text-white"></i></a>
        </div>
      </div>
