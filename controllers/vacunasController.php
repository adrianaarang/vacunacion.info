...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['accion']) && $_POST['accion'] === 'crear') {
    ...
    if ($existe > 0) {
        header("Location: /TFG/views/vacunas_gestion.php?error=duplicado");
        exit;
    }
    ...
    header('Location: /TFG/views/vacunas_gestion.php?ok=creado');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['accion'] === 'editar') {
    ...
    header('Location: /TFG/views/vacunas_gestion.php?ok=editado');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['accion'] === 'eliminar') {
    ...
    header('Location: /TFG/views/vacunas_gestion.php?ok=eliminado');
    exit;
}

// Obtener todas las vacunas (para la vista)
